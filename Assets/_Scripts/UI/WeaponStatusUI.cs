...
public class WeaponStatusUI : MonoBehaviour
{
    ...
    private void UpdateActiveWeaponName(Weapon weapon)
    {
        ...
        weaponNameText.text = "(" + weapon.weaponPositionInList + ") " + weapon.weaponDetails.weaponName.ToUpper();
    }
    ...
    private void UpdateAmmoText(Weapon weapon)
    {
        if (weapon.weaponDetails.hasInfiniteAmmo)
            ...
            ammoRemainingText.text = weapon.weaponClipAmmoRemaining.ToString() + " / " + weapon.weaponTotalAmmoRemaining.ToString();
    }
